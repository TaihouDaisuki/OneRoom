...
public:
	...
	UserInfo(QString nickName, QString userName, QString loginTime = QString::null, QString password = QString::null);
	void operator=(const UserInfo &info);	
	void setInfo(QString nickName, QString userName, QString loginTime = QString::null, QString password = QString::null);
	QSize rectSize();
